    ...
    return (
        <><div className='w-full flex justify-between items-center font-semibold'>
            ...
            <div className='flex items-center gap-4'>
                ...
                <p className='bg-blue-500 text-black w-7 h-7 rounded-full flex items-center justify-center cursor-pointer'>M</p>
            </div>
            </div>
           <div className='flex items-center gap-2 mt-4'>
                ...
                <p className='bg-black px-4 py-1 rounded-2xl cursor-pointer'>Audiobooks</p>
           </div>
            </>
